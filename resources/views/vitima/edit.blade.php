        ...
        <form method="POST" class="space-x-2" action="{{ route('vitima.update') }}">
            ...
            <div class="grid grid-cols-2 gap-4 mt-4 mb-4">
                ...
                <div class="sm:col-span-1 col-span-2 ">
                    <div>
                        ...
                        <x-text-input id="name" type="text" name="name" placeholder="Nome" :value="Auth::user()->name" required autofocus autocomplete="name" />
               ...
               <!-- Sobrenome -->
                <div class="sm:col-span-1 col-span-2 ">
                    ...
                    <x-text-input id="lastname" type="text" name="lastname" placeholder="Sobrenome" :value="Auth::user()->lastname" required autofocus autocomplete="lastname" />
                ...
                <div class="sm:col-span-1 col-span-2 ">
                    ...
                    <x-text-input id="username" type="text" name="username" placeholder="Nome de Usuário" :value="Auth::user()->username" required autofocus autocomplete="username" />
               ...
               <!-- Senha -->
                ...
                <div class="col-span-2">
                    <div>
                        ...
                        <x-text-input id="email" type="email" name="email" placeholder="E-mail" :value="Auth::user()->email" required autocomplete="email" />
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="sm:col-span-1 col-span-2 ">
                    ...
                    <x-text-input id="contact" type="number" name="contact" placeholder="( __ ) _______-______" :value="Auth::user()->contacts()->first()->contact"  autofocus autocomplete="contact" />
                ...
                <div class="sm:col-span-1 col-span-2 ">
                    ...
                    <x-text-input id="contact2" type="number" name="contact2" placeholder="( __ ) _______-______" :value="Auth::user()->contacts()->orderBy('contact', 'desc')->first()->contact"  autofocus autocomplete="contact2" />
