        ...
        <div class="flex justify-between ">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @if (Auth::user() && Auth::user()->id_type === 3)
                    <div class="max-[950px]:invisible space-x-8 sm:-my-px sm:ml-1 sm:flex">
                        <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                            {{ __('Home') }}
                        </x-nav-link>
                    </div>
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="max-[950px]:hidden bg-white border-2 border-red-500 duration-500 font-bold hover:bg-red-500 hover:text-white mx-3 navbar-btn px-3 py-2 rounded text-red-500 text-xl">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        @if (Auth::user() && Auth::user()->id_type === 3)
                        <button class="flex max-[950px]:hidden text-sm bg-white border-2 border-red-500 duration-500 hover:bg-red-500 hover:border-4 mx-2 navbar-btn rounded-full">
                        @else
                        ...
                        @endif
                            ...
                            @else
                                <img class="h-12 w-12 rounded-full" src="{{ asset('img/icons/user.png') }}">
                            @endif
                        </button>
                    </x-slot>
            ...
            <!-- Hamburger -->
            @if (Auth::user() && Auth::user()->id_type === 3)
            <div class="-mr-2 flex items-center min-[950px]:hidden">
            @else
