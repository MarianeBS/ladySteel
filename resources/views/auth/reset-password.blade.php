<x-guest-layout>
    <div class="bg-white overflow-hidden rounded-xl shadow-lg mx-5">
        ...
        <form method="POST" action="{{ route('password.store') }}" class="p-10">
            @csrf
            ...
            <div class="mt-4 relative">
                ...
                <button type="button" class="absolute top-6 sm:right-[1%] right-[10%]  p-3 text-sm font-medium text-black">
            ...
            <div class="flex items-center justify-end mt-4">
                <button class="bg-red-500 block font-bold p-2.5 rounded text-lg text-white w-full">
                    Redefinir senha
                </button>
            </div>
        </form>
